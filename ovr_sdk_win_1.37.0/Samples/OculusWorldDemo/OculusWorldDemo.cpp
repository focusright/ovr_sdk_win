...
void OculusWorldDemoApp::PopulateOptionMenu()
{
    ...
    */
    ...
    Menu.AddBool( "Layers.Protected Layer Enabled", &LayerHdcpEnabled);
          ...
          case OculusWorldDemoApp::DRScissorTechnique_ProjectCorners:
            {
              ...
              scissorFov.UpTan    = OVRMath_Max(    -leftUp.y,  -rightUp.y);
              scissorFov.DownTan  = OVRMath_Max(   leftDown.y, rightDown.y);
              scissorFov.LeftTan  = OVRMath_Max(     leftUp.x,  leftDown.x);
              scissorFov.RightTan = OVRMath_Max( -rightDown.x,  -rightUp.x);
            }
            break;
