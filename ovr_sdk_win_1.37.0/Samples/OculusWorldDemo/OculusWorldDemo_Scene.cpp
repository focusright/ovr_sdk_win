...
void OculusWorldDemoApp::RenderController(CamRenderPoseEnum camNum, const ovrPosef pose, const Vector4f color, bool rightSide) {
...
void OculusWorldDemoApp::RenderControllers(CamRenderPoseEnum camNum, ovrEyeType eyeNum )
{
...

    {
      if (ConnectedControllerTypes & ovrControllerType_LTouch) {
        RenderController(camNum, HandPoses[ovrHand_Left], Vector4f(1.0f, 1.0f, 1.0f, 1.0f), false);
      }
      if (ConnectedControllerTypes & ovrControllerType_RTouch) {
        RenderController(camNum, HandPoses[ovrHand_Right], Vector4f(1.0f, 1.0f, 1.0f, 1.0f), true);
      }
    }
